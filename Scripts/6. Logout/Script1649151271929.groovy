...
WebUI.click(findTestObject('Object Repository/Page_Sehati Dashboard/a_nama_puskesmas'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Object Repository/Page_Sehati Dashboard/button_keluar'))

WebUI.takeScreenshot()

WebUI.verifyTextPresent('Masuk Sebagai', false)
